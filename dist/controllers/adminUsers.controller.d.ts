...
export declare const updateUserSubscriptionStatus: (req: Request, res: Response, next: NextFunction) => Promise<void>;
//# sourceMappingURL=adminUsers.controller.d.ts.map