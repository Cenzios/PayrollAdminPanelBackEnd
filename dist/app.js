...
const admin_plans_routes_1 = __importDefault(require("./routes/admin.plans.routes"));
...
const admin_notifications_routes_1 = __importDefault(require("./routes/admin.notifications.routes"));
const admin_manualpayments_routes_1 = __importDefault(require("./routes/admin.manualpayments.routes"));
...
app.use('/api/admin/plans', admin_plans_routes_1.default);
...
app.use('/api/admin/notifications', admin_notifications_routes_1.default);
app.use('/api/admin/manual-payments', admin_manualpayments_routes_1.default);
